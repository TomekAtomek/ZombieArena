...
void Player::spawn(sf::IntRect arena, sf::Vector2f resolution, uint16_t tileSize)
{
...
void Player::increaseHealthLevel ( uint16_t amount )
{
    m_Health += amount;     // But not beyond the maximum
